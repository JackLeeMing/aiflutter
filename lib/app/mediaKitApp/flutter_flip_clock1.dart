...
///
/// An enum defines all supported directions of [_FlipPanel]
///
...
class _FlipPanel<T> extends StatefulWidget {
  ...
  StreamItemBuilder<T>? streamItemBuilder;
  Stream<T>? itemStream;
...
class _FlipPanelState<T> extends State<_FlipPanel> with SingleTickerProviderStateMixin {
