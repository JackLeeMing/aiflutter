    ...
    return Scaffold(
        ...
        body: LiquidSwipe(key: _key, children: [
          FlutterLiquidSwipeCard(
              ...
              child: ClipRRect(
                  borderRadius: BorderRadius.circular(10), child: Image.network("https://picsum.photos/300/200"))),
          FlutterLiquidSwipeCard(
              ...
              child: ClipRRect(
                  borderRadius: BorderRadius.circular(10), child: Image.network("https://picsum.photos/350/200"))),
        ]));
  }
}
