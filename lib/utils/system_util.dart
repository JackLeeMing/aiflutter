...
double getAppBarHeight({bool withBottom = false}) {
  if (withBottom) {
    if (_appBarHeightBottom != 0) {
      ...
      final height = AppBar(bottom: const TabBar(tabs: const [])).preferredSize.height;
...
Future push<T extends StatefulWidget>(BuildContext context, {required T page, bool replace = false}) {
