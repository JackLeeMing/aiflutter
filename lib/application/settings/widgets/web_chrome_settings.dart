...
import 'package:aiflutter/application/settings/widgets/web_chrome_addresses_settings.dart';
          ...
          SettingsSection(
            ...
            tiles: [
              ...
              SettingsTile.navigation(
                ...
                title: Text('Security'),
                description: Text('Safe Browsing (protection from dangerous sites) and other security settings'),
              ),
              SettingsTile.navigation(
                onPressed: (_) {},
                ...
                description:
                    Text('Controls what information sites can use and show (location, camera, pop-ups and more)'),
              ),
              SettingsTile.navigation(
                onPressed: (_) {},
